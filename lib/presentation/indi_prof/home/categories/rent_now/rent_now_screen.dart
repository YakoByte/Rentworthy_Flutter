      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            ).animate().fadeIn(duration: 700.ms).then(delay: 700.ms).slideY(
                begin: 10,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 800.ms),
            ...
            ).animate().fadeIn(duration: 800.ms).then(delay: 800.ms).slideY(
                begin: 10,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 800.ms),
            ...
            ).animate().fadeIn(duration: 900.ms).then(delay: 900.ms).slideY(
                begin: 10,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 800.ms),
                      ...
                      CommonOutlineButton(
                        ...
                        textStyle: ptSansTextStyle(
                            foreground: Paint()
                              ...
                              ).createShader(Rect.fromLTRB(200, 0, 350, 20)),
                            fontSize: h * 0.021,
                            fontWeight: FontWeight.w700),
                        onPressed: () {
                          FocusScope.of(Globals.navigatorKey.currentContext!)
            ...
            ).animate().fadeIn(duration: 1000.ms).then(delay: 1000.ms).slideY(
                begin: 10,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 800.ms),
            ...
            ).animate().fadeIn(duration: 1100.ms).then(delay: 1100.ms).slideY(
                begin: 10,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 800.ms),
            ...
            ).animate().fadeIn(duration: 1200.ms).then(delay: 1200.ms).slideY(
                begin: 10,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 800.ms),
