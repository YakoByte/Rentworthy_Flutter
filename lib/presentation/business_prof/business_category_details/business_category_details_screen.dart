...
class BusinessCategoryDetails extends ConsumerWidget {
  bool? isfromNavDrawer;

  BusinessCategoryDetails({super.key, this.isfromNavDrawer = false});
      ...
      body: asyncState.when(
          data: (data) {
            if (controller().isLoading) {
              return SafeArea(child: CategoryDetailsShimmer());
            }
            return SafeArea(
              child: Padding(
                padding: EdgeInsets.symmetric(
