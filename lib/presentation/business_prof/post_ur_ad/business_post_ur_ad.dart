        ...
        child: Column(
          children: [
            ...
            Divider(
              ...
              height: h * 0.01,
              thickness: 1,
            ).animate().fadeIn(duration: 260.ms).then(delay: 260.ms).slideX(
                begin: 2,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 700.ms),
                ...
                children: [
                  ...
                  TextInputField(
                          ...
                          prefix: IntrinsicHeight(
                            child: Padding(
                              padding:
                                  EdgeInsets.symmetric(horizontal: w * 0.012),
                              child: Row(
                                children: [
                                  Icon(
                                    Icons.quora,
            ...
            Divider(
              ...
              height: h * 0.01,
              thickness: 1,
            ).animate().fadeIn(duration: 450.ms).then(delay: 450.ms).slideX(
                begin: 2,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 910.ms),
            ...
            ).animate().fadeIn(duration: 480.ms).then(delay: 480.ms).slideX(
                begin: 2,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 1100.ms),
            Divider(
              ...
              height: h * 0.025,
              thickness: 1,
            ).animate().fadeIn(duration: 510.ms).then(delay: 510.ms).slideX(
                begin: 2,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 1200.ms),
            ...
            ).animate().fadeIn(duration: 540.ms).then(delay: 540.ms).slideX(
                begin: 2,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 1300.ms),
            Divider(
              ...
              height: h * 0.025,
              thickness: 1,
            ).animate().fadeIn(duration: 550.ms).then(delay: 550.ms).slideX(
                begin: 2,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 1400.ms),
            ...
            Divider(
              ...
              height: h * 0.035,
              thickness: 1,
            ).animate().fadeIn(duration: 650.ms).then(delay: 650.ms).slideX(
                begin: 2,
                end: 0,
                curve: Curves.easeInOutCubic,
                duration: 1600.ms),
