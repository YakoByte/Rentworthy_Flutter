    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Padding(
            padding:
                EdgeInsets.symmetric(horizontal: w * 0.035, vertical: h * 0.02),
            child: Column(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                                                  ...
                                                                  style:
                                                                    ...
                                                                    foreground:
                                                                        Paint()
                                                                          ...
                                                                          ).createShader(const Rect.fromLTRB(80, 0, 550, 20)),
                                                                    fontSize:
                                                                        w * 0.03,
                                                                    fontWeight:
                                                                        FontWeight
                                    ...
                                    if (controller().isInvoiceTap == true)
                                      Divider(
                                ...
                                .animate(
                                    controller:
                                        controller().animatecontrollerlist![p1],
                                    ...
                                    // },
                                    autoPlay: false)
                                .fadeIn(duration: ((p1 * 40) + 100).ms)
                                .then(delay: ((p1 * 40) + 100).ms)
                                .slideX(
                                    begin: 1,
                                    end: 0,
                                    curve: Curves.easeInOutCubic,
