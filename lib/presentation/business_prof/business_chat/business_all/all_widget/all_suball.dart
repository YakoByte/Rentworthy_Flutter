...
class BusinessAllSubAll extends ConsumerWidget {
  const BusinessAllSubAll({super.key});
          ...
          itemBuilder: (BuildContext, index) {
            return Padding(
              ...
              child: Column(
                ...
                .animate(
                  controller: controller().animatecontrollerlist![index],
                  autoPlay: false,
                  // onComplete: (controller1) {
                  //   for (int i = 0;
                  //       i < controller().animatecontrollerlist!.length;
                  //       i++) {
                  //     if (controller().animatecontrollerlist![i].isCompleted &&
                  //         i <
                  //             (controller().animatecontrollerlist!.length -
                  //                 1)) {
                  //       controller().animatecontrollerlist![i + 1].forward();
                  //     }
                  //   }
                  // },
                )
