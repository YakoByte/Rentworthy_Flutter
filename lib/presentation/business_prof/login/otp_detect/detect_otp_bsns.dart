...
import 'detect_otp_bsns_controller.dart';

class BusinessDetectOtp extends ConsumerWidget {
  String phoneNo;

  BusinessDetectOtp({super.key, required this.phoneNo});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncState = ref.watch(businessDetectOtpControllerProvider);
    controller() => ref.read(businessDetectOtpControllerProvider.notifier);
