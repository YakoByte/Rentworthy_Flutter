...
class BusinessRentScreeningDialog extends ConsumerStatefulWidget {
// = TextEditingController(text: "0");
  const BusinessRentScreeningDialog({
    super.key,
  });

  @override
  ConsumerState createState() => _BusinessRentScreeningDialogState();
}

class _BusinessRentScreeningDialogState
    extends ConsumerState<BusinessRentScreeningDialog> {
  @override
