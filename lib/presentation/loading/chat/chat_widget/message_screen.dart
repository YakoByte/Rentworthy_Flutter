                    ...
                    children: [
                                    ...
                                    foreground: Paint()
                                      ..shader = const LinearGradient(
                                        colors: <Color>[
                                          ...
                                          const Rect.fromLTRB(30, 10, 100, 20)),
                                    fontSize: h * 0.025,
                                    fontWeight: FontWeight.w700),
                                text: AppText.chats)
                          ],
                      ...
                      ShaderMask(
                        shaderCallback: (Rect bounds) {
                          ...
                          ).createShader(Rect.fromLTRB(30, 10, 100, 20));
                        },
                        child: Divider(
                          height: h * 0.01,
                          thickness: h * 0.0025,
                      ...
                      CommonListView(
                          itemCount: controller().getquestionList.length,
                          scrollDirection: Axis.vertical,
                          shrinkWrap: true,
                          padding: EdgeInsets.symmetric(
                                ...
                                child: Padding(
                                  ...
                                  child: CommonText(
                                      style: ptSansTextStyle(
                                          ...
                                          fontWeight: FontWeight.w700),
                                      text:
                                          controller().getquestionList[index]),
                                ),
                              ),
                            );
                          }),
