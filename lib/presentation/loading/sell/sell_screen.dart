...
import 'package:rentworthy/presentation/loading/sell/post_add/post_ur_ad.dart';
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  curve: Curves.easeInOutCubic,
                  duration: 400.ms),
            ]).animate().fadeIn(duration: 30.ms).then(delay: 20.ms).slideY(
            begin: 1, end: 0, curve: Curves.easeInOutCubic, duration: 600.ms),
      ),
    );
  }
}
