    ...
    switch (state) {
      ...
      case StepState.complete:
        return Icon(
          ...
          color: widget.iconcolor,
          size: widget.iconsize, // ### TODO: why is check_mark so small?
        );
  ...
  Widget _buildCircle(int index, bool oldState) {
    return Container(
      ...
      child: AnimatedContainer(
        ...
        decoration: widget.gradientDec == false
            ? ShapeDecoration(
                color: _circleColor(index),
                shape:
                    CircleBorder(side: BorderSide(color: _borderColor(index))),
              )
            : BoxDecoration(
                color: _circleColor(index),
