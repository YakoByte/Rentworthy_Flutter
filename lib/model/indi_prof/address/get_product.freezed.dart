...
abstract class $ProductResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ProductData>? products, int? total, int? skip, int? limit});
}
...
class _$ProductResponseImpl implements _ProductResponse {
  const _$ProductResponseImpl(
      {required final List<ProductData>? products,
      required this.total,
      required this.skip,
      required this.limit})
      : _products = products;
...
class _$ProductDataImpl implements _ProductData {
  ...
  @override
  String toString() {
    return 'ProductData(id: $id, title: $title, description: $description, price: $price, discountPercentage: $discountPercentage, rating: $rating, stock: $stock, brand: $brand, category: $category, thumbnail: $thumbnail, images: $images)';
  }
...
abstract class _ProductData implements ProductData {
  const factory _ProductData(
      ...
      required final List<String>? images}) = _$ProductDataImpl;
